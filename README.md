...
- Practice German verb conjugation
- Use any German text in pdf, epub, docx, txt, pptx format
- Uses spaCy engine to give you hints
- Creates fill in the gaps exercises
- No coding required!
...
| -------------------------------------------------------------- |- |
Start the app and select the text.|<img src="80_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 3 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
Start conjugating the verbs.|<img src="120_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 4 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
For each right answer, you will get a point.|<img src="160_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 5 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
The app will show you the text sentence by sentence. Keep conjugating<br>German verbs.|<img src="200_800x800.png" width="400"/> |
